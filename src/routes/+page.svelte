			...
			>
				...
				{#if traceRootGhost}
					...
					>
						...
						>
							<Avatar.Root class={`avatar avatar-${traceRootGhost.tone}`}>
								<Avatar.Image src={asset(`/${traceRootGhost.character.picture}`)} alt="" />
								<Avatar.Fallback>{traceRootGhost.character.name.slice(0, 1)}</Avatar.Fallback>
							</Avatar.Root>
