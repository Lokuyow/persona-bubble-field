...
<style>
	...
	.speaker-button { width: 38px; height: 38px; padding: 0; border: 1px solid rgba(255,255,255,.38); border-radius: 50%; background: rgba(10,17,35,.64); color: white; font-size: 17px; cursor: pointer; box-shadow: 0 3px 12px rgba(0,0,0,.18); backdrop-filter: blur(8px); }
